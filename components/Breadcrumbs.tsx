            ...
            <div className="flex items-center">
              ...
              {breadcrumb.href ? (
                <Link
                  ...
                  className="ml-4 text-sm font-medium capitalize text-zinc-500 hover:text-zinc-700"
                  aria-current={breadcrumb.href === pathname ? 'page' : undefined}
                >
                  {breadcrumb.name.replace(/-/g, ' ')}
                </Link>
              ) : (
                <span className="ml-4 text-sm font-medium text-zinc-500 hover:text-zinc-700">
                  {breadcrumb.name.replace(/-/g, ' ')}
                </span>
              )}
            </div>
