import type { QueryBlogSlugPageDataResult } from '@maricopa-senior-living/sanity/types'
...
export type SanityRichTextProps = NonNullable<QueryBlogSlugPageDataResult>['richText']
