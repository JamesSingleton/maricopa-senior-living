...
export const service = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Website",
      description:
        "Is there a website URL people can go to? If so, add it here.",
    }),
    defineField({
      type: "string",
      name: "phone",
      title: "Phone Number",
      description:
        "Is there a phone number people can call? If so, add it here.",
    }),
    defineField({
      type: "string",
      name: "address",
      ...
      of: [
        {
          ...
          fields: [
            defineField({
              ...
              type: "string",
              description:
                "Name of the file (this will be displayed on the website)",
              validation: (rule) => rule.required(),
            }),
          ],
        },
