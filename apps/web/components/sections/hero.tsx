import { Badge } from '@maricopa-senior-living/ui/components/badge'
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div className="grid h-full grid-rows-[auto_1fr_auto] items-center justify-items-center gap-4 text-center lg:items-start lg:justify-items-start lg:text-left">
            ...
            <div className="grid gap-4">
              <h1 className="text-4xl font-semibold text-balance lg:text-6xl">{title}</h1>
              <RichText className="text-base font-normal md:text-lg" richText={richText} />
            </div>
            <SanityButtons
