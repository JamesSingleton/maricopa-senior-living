...
function SlugInputField({ value, onChange, readOnly, placeholder }: SlugInputProps) {
  ...
  return (
    <Stack space={2}>
      ...
      <Flex align="center" gap={2}>
        ...
        <CopyButton icon={CopyIcon} mode="ghost" onClick={onCopy} padding={2} title="Copy URL" />
      </Flex>
    </Stack>
  )
}
      ...
      <Stack space={4}>
        <Stack space={2}>
          ...
          <Flex align="center" gap={2}>
            ...
            <SlugGenerateButton
              disabled={!(typeof document?.title === 'string' && document.title.trim()) || readOnly}
        ...
        {currentSlug && <UrlPreviewSection onCopy={handleCopyUrl} url={fullUrl} />}
      </Stack>
